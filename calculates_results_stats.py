...
#            n_correct_notdogs - number of correctly classified NON-dog images       DONE
...
def calculates_results_stats(results_dic):
    ...
    #Initialize dictionary keys which count results
    ...
    results_stats_dic['n_labels_match'] = 0
    #Count results
    for key in results_dic:
        ...
        if results_dic[key][2] == 1:
            results_stats_dic['n_labels_match'] += 1       
    ...
    results_stats_dic['pct_label_match'] = (results_stats_dic['n_labels_match']/results_stats_dic['n_images'])*100    
